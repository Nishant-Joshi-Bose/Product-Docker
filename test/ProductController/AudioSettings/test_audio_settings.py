...
def test_audio_contentitem(frontDoor_conn):
	...
	Test Objctive:
		...
		1. Set source to TV
		2. Set to CONTENT_ITEM with a value of 20 (PRODUCT_TV)
		3. Change source to PRODUCT
		4. Set to CONTENT_ITEM with a value of 30 (PRODUCT_)
		5. Change source to TV
		6. Verify, should be CONTENT_ITEM with value of 20 (PRODUCT_TV)
		7. Change source to PRODUCT
		8. Verify, should be CONTENT_ITEM with value of 30 (PRODUCT_)
	"""
...
"""
	Test Structure:
		...
		9. Set to CONTENT_ITEM with a value of 20 (PRODUCT_TV)
		10. Change source to PRODUCT
		11. Set to CONTENT_ITEM with a value of 30 (PRODUCT_)
		12. Change source to TV
		13. Verify, should be CONTENT_ITEM with value of 20 (PRODUCT_TV)
		14. Change source to PRODUCT
		15. Verify, should be CONTENT_ITEM with value of 30 (PRODUCT_)
"""
###################################################################################################
'''
# bass
