...
processes_to_track="APServer|AVS|A4V|Bose|BT|BLESetup|CLIServer|ClockSync|Deezer|Device|Professor|FrontDoor|GalapagosClient|HTTPProxy|IHeart|Iot|LPMService|Passport|Professor|NetManger|Server|Software|Spotify|SWUpdateWebServer|STS|Telnet|STSCertified|UpnpSource|Vfe"
