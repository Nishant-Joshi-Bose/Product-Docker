...
private:
    ...
    ProductWirelessStatus m_wirelessStatus;
    void EvaluateRadioStatus( );

    ////////////////////////////////////////////////////////////////////////////////////////////////
    ///
    /// @brief Memeber functions and vars to cache BT Out ( Source ) Status
    ///
    ////////////////////////////////////////////////////////////////////////////////////////////////
    BluetoothSourceService::AppStatus m_btOutStatus;
    void HandleBTOutStatus( const BluetoothSourceService::AppStatus& status );
