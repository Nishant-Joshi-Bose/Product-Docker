...
enum ProductControllerStates
{
    ...
    ///
    /// CASTLE-5315 will change the following state to PRODUCT_CONTROLLER_STATE_ON.
    ///
    PROFESSOR_PRODUCT_CONTROLLER_STATE_ON                           = 13,
    ...
    ///
    /// CASTLE-5315 will change the following state to PRODUCT_CONTROLLER_STATE_PLAYING_INACTIVE.
    ///
    PROFESSOR_PRODUCT_CONTROLLER_STATE_PLAYING_INACTIVE             = PRODUCT_CONTROLLER_STATE_ON,
