...
namespace ProductApp
{
    ...
    ///
    /// @brief This class provides functionality for sending and receiving information through a Front
    ///        Door network router process, which handles connections and communications between various
    ///        Bose processes.
    ///
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    class ProductFrontDoorNetwork
    {
      public:
          ...
          ///
          /// @brief  This static method creates the one and only instance of a ProductFrontDoorNetwork
      ...
      private:
          ...
          //////////////////////////////////////////////////////////////////////////////////////////////
          ///
          /// The following copy constructor and equality operator for this class are private and are
          /// set to be undefined through the delete keyword. This prevents this class from being copied
          /// directly, so that only the static method GetInstance to this class can be used to get the
          /// one sole instance of it.
          ///
          //////////////////////////////////////////////////////////////////////////////////////////////
          ...
          //////////////////////////////////////////////////////////////////////////////////////////////
          /// This declaration stores the main task for processing network events and requests. It is
          /// inherited by the ProductFrontDoorNetwork instance.
          //////////////////////////////////////////////////////////////////////////////////////////////
          ...
          //////////////////////////////////////////////////////////////////////////////////////////////
          ///
          /// The following member is a shared pointer to the Front Door network interface for routing
          /// messages between the various Bose processes.
          ///
          //////////////////////////////////////////////////////////////////////////////////////////////
