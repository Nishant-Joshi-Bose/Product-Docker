...
static std::unordered_map < ProductApp::KeyActionMode_t, CountDownInfo> m_countdownIntentInfoMap =
{
    ...
    {( std::make_pair( ProductApp::Action::SOFTWARE_INSTALL_COUNTDOWN, 0 ) ), {ButtonEventName::SOFTWARE_INSTALL, 10}}
};
...
bool CountDownManager::Handle( KeyHandlerUtil::ActionType_t& intent )
{
    ...
    case( uint16_t ) Action::SOFTWARE_INSTALL_CANCEL:
    {
    ...
    case( uint16_t ) Action::SOFTWARE_INSTALL_COUNTDOWN:
    {
