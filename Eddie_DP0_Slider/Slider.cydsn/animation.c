...
//============================================================ static variables
//=============================================================================
static t_struct_animation vec_call_back_anim[ANIM_UNKNOWN] = {{ANIM_BUTTON_SMOOTH_SLOW   , TRUE , FALSE, animate_button_smooth_slow   , "slow breather"                     },
                                                              {ANIM_BUTTON_SMOOTH_FAST   , TRUE , FALSE, animate_button_smooth_fast   , "fast breather"                     },
...
static BOOL             is_auto_anim_rotation_enable = FALSE; // when enable: auto rotation of the lightbar animation
static BOOL             is_anim_on_button_up_enable  = FALSE; // when anable: start the selected lightbar animation on a button up
...
{
    animate_button_smooth(vec_call_back_anim[ANIM_BUTTON_SMOOTH_SLOW].high_speed ? 0x10 : 0x04);
}// animate_button_smooth_slow
...
{
    animate_button_smooth(vec_call_back_anim[ANIM_BUTTON_SMOOTH_FAST].high_speed ? 0x02 : 0x00);
}// animate_button_smooth_fast
