...
CY_ISR(I2CS_I2C_ISR)
{
    ...
    */
    ...
    {
        I2CS_CTRL_REG &= (uint32) ~I2CS_CTRL_ENABLED; /* Disable scb IP */

        I2CS_state = I2CS_I2C_FSM_IDLE;

        I2CS_DISABLE_SLAVE_AUTO_DATA;
        I2CS_DISABLE_MASTER_AUTO_DATA;
        ...
        I2CS_ClearTxInterruptSource(I2CS_INTR_RX_ALL);
        I2CS_ClearRxInterruptSource(I2CS_INTR_TX_ALL);
        I2CS_ClearSlaveInterruptSource(I2CS_INTR_SLAVE_ALL);
        I2CS_ClearMasterInterruptSource(I2CS_INTR_MASTER_ALL);
    #endif /* (I2CS_CY_SCBIP_V0) */

        I2CS_CTRL_REG |= (uint32) I2CS_CTRL_ENABLED;  /* Enable scb IP */
    }
