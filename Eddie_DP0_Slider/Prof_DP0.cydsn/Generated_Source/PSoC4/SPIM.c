    ...
    *******************************************************************************/
    void SPIM_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        else if (SPIM_SCB_MODE_SPI == mode)
        {
            ...
            hsiomSel[SPIM_CTS_SCLK_PIN_INDEX] = SPIM_CTS_SCLK_HSIOM_SEL_SPI;
            ...
            if (SPIM_SPI_SLAVE == subMode)
            {
                ...
                pinsDm[SPIM_CTS_SCLK_PIN_INDEX] = SPIM_PIN_DM_DIG_HIZ;

            #if (SPIM_RTS_SS0_PIN)
                /* Only SS0 is valid choice for Slave */
                hsiomSel[SPIM_RTS_SS0_PIN_INDEX] = SPIM_RTS_SS0_HSIOM_SEL_SPI;
                pinsDm  [SPIM_RTS_SS0_PIN_INDEX] = SPIM_PIN_DM_DIG_HIZ;
            ...
            else 
            {
                ...
                pinsDm[SPIM_CTS_SCLK_PIN_INDEX] = SPIM_PIN_DM_STRONG;

            #if (SPIM_RTS_SS0_PIN)
                hsiomSel [SPIM_RTS_SS0_PIN_INDEX] = SPIM_RTS_SS0_HSIOM_SEL_SPI;
                pinsDm   [SPIM_RTS_SS0_PIN_INDEX] = SPIM_PIN_DM_STRONG;
                pinsInBuf |= SPIM_RTS_SS0_PIN_MASK;
            #endif /* (SPIM_RTS_SS0_PIN) */
            ...
            #if (SPIM_CTS_SCLK_PIN)
                pinsInBuf |= SPIM_CTS_SCLK_PIN_MASK;
            #endif /* (SPIM_CTS_SCLK_PIN) */
            }
        }
        else /* UART */
        {
            ...
            else /* Standard or IrDA */
            {
                ...
                if (SPIM_UART_MODE_STD == subMode)
                {
                    ...
                    #if (SPIM_CTS_SCLK_PIN)
                        hsiomSel[SPIM_CTS_SCLK_PIN_INDEX] = SPIM_CTS_SCLK_HSIOM_SEL_UART;
                        pinsDm  [SPIM_CTS_SCLK_PIN_INDEX] = SPIM_PIN_DM_DIG_HIZ;
                    #endif /* (SPIM_CTS_SCLK_PIN) */
                    }
                    ...
                    #if (SPIM_RTS_SS0_PIN)
                        hsiomSel[SPIM_RTS_SS0_PIN_INDEX] = SPIM_RTS_SS0_HSIOM_SEL_UART;
                        pinsDm  [SPIM_RTS_SS0_PIN_INDEX] = SPIM_PIN_DM_STRONG;
    ...
    #if (SPIM_CTS_SCLK_PIN)
        SPIM_SET_HSIOM_SEL(SPIM_CTS_SCLK_HSIOM_REG,
                                       SPIM_CTS_SCLK_HSIOM_MASK,
                                       SPIM_CTS_SCLK_HSIOM_POS,
                                       hsiomSel[SPIM_CTS_SCLK_PIN_INDEX]);

        SPIM_uart_cts_spi_sclk_SetDriveMode((uint8) pinsDm[SPIM_CTS_SCLK_PIN_INDEX]);

        SPIM_SET_INP_DIS(SPIM_uart_cts_spi_sclk_INP_DIS,
                                     SPIM_uart_cts_spi_sclk_MASK,
                                     (0u != (pinsInBuf & SPIM_CTS_SCLK_PIN_MASK)));
    #endif /* (SPIM_CTS_SCLK_PIN) */

    #if (SPIM_RTS_SS0_PIN)
        SPIM_SET_HSIOM_SEL(SPIM_RTS_SS0_HSIOM_REG,
                                       SPIM_RTS_SS0_HSIOM_MASK,
                                       SPIM_RTS_SS0_HSIOM_POS,
                                       hsiomSel[SPIM_RTS_SS0_PIN_INDEX]);

        SPIM_uart_rts_spi_ss0_SetDriveMode((uint8) pinsDm[SPIM_RTS_SS0_PIN_INDEX]);

        SPIM_SET_INP_DIS(SPIM_uart_rts_spi_ss0_INP_DIS,
                                     SPIM_uart_rts_spi_ss0_MASK,
                                     (0u != (pinsInBuf & SPIM_RTS_SS0_PIN_MASK)));
    #endif /* (SPIM_RTS_SS0_PIN) */
