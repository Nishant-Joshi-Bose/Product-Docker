...
#define UART_1_UART_DROP_ON_FRAME_ERR     (1u)
#define UART_1_UART_DROP_ON_PARITY_ERR    (0u)
#define UART_1_UART_WAKE_ENABLE           (0u)
#define UART_1_UART_RX_BUFFER_SIZE        (128u)
#define UART_1_UART_TX_BUFFER_SIZE        (128u)
...
#define UART_1_UART_INTR_RX_MASK          (68u)
#define UART_1_UART_INTR_TX_MASK          (32u)
