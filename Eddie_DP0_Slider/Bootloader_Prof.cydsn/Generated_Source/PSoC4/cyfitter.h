...
/* Miscellaneous */
#define CY_PROJECT_NAME "Bootloader_Prof"
...
#define CYDEV_BOOTLOADER_IO_COMP_I2CS 2
#define CyBtldr_I2CS CYDEV_BOOTLOADER_IO_COMP_I2CS
#define CYDEV_BOOTLOADER_IO_COMP CYDEV_BOOTLOADER_IO_COMP_I2CS
