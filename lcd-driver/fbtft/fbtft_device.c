...
static int tianma_tm028hdhg59_seq[] = {
	-1, 0x11,
	-2, 120,
	//display and color format setting
	-1, 0x36, 0x00, 0x3A, 0x06,
	//Porch setting
	-1, 0xB2,0x0C,0x0C,0x00,0x33,0x33,
	...
	-1, 0xD0,0xA4,0xA1,
	-1, 0xE8,0x83,
	-1, 0xE0,0xD2,0x13,0x16,0x0D,0x0F,0x38,0x3D,0x43,0x4D,0x1B,0x16,0x14,0x1B,0x1F,
	-1, 0xE1,0xD2,0x13,0x16,0x0D,0x0F,0x38,0x3D,0x43,0x4D,0x1B,0x16,0x14,0x1B,0x1F,
	-1, 0x29,
	-1, 0x2C,
};
		...
		.spi = &(struct spi_board_info) {
			...
			.platform_data = &(struct fbtft_platform_data) {
				.display = {
					.buswidth = 9,
					.backlight = 1,
					.init_sequence = tianma_tm028hdhg59_seq,
				},
				.bgr = true,
				.gpios = (const struct fbtft_gpio []) {
					{ "reset", 25 },
