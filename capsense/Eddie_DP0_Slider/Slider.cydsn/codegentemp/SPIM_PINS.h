...
#define SPIM_REMOVE_CTS_SCLK_PIN      (1u)
#define SPIM_REMOVE_RTS_SS0_PIN      (1u)
...
#define SPIM_REMOVE_SPI_MASTER_SCLK_PIN     (0u)
#define SPIM_REMOVE_SPI_MASTER_MOSI_PIN     (0u)
...
#define SPIM_CTS_SCLK_PIN     (0u == SPIM_REMOVE_CTS_SCLK_PIN)
#define SPIM_RTS_SS0_PIN     (0u == SPIM_REMOVE_RTS_SS0_PIN)
...
#if (SPIM_CTS_SCLK_PIN)
    #include "SPIM_uart_cts_spi_sclk.h"
#endif /* (SPIM_CTS_SCLK) */

#if (SPIM_RTS_SS0_PIN)
    #include "SPIM_uart_rts_spi_ss0.h"
#endif /* (SPIM_RTS_SS0_PIN) */
...
#if (SPIM_CTS_SCLK_PIN)
    #define SPIM_CTS_SCLK_HSIOM_REG   (*(reg32 *) SPIM_uart_cts_spi_sclk__0__HSIOM)
    #define SPIM_CTS_SCLK_HSIOM_PTR   ( (reg32 *) SPIM_uart_cts_spi_sclk__0__HSIOM)
    
    #define SPIM_CTS_SCLK_HSIOM_MASK      (SPIM_uart_cts_spi_sclk__0__HSIOM_MASK)
    #define SPIM_CTS_SCLK_HSIOM_POS       (SPIM_uart_cts_spi_sclk__0__HSIOM_SHIFT)
    #define SPIM_CTS_SCLK_HSIOM_SEL_GPIO  (SPIM_uart_cts_spi_sclk__0__HSIOM_GPIO)
    #define SPIM_CTS_SCLK_HSIOM_SEL_I2C   (SPIM_uart_cts_spi_sclk__0__HSIOM_I2C)
    #define SPIM_CTS_SCLK_HSIOM_SEL_SPI   (SPIM_uart_cts_spi_sclk__0__HSIOM_SPI)
    #define SPIM_CTS_SCLK_HSIOM_SEL_UART  (SPIM_uart_cts_spi_sclk__0__HSIOM_UART)
#endif /* (SPIM_CTS_SCLK_PIN) */

#if (SPIM_RTS_SS0_PIN)
    #define SPIM_RTS_SS0_HSIOM_REG   (*(reg32 *) SPIM_uart_rts_spi_ss0__0__HSIOM)
    #define SPIM_RTS_SS0_HSIOM_PTR   ( (reg32 *) SPIM_uart_rts_spi_ss0__0__HSIOM)
    
    #define SPIM_RTS_SS0_HSIOM_MASK      (SPIM_uart_rts_spi_ss0__0__HSIOM_MASK)
    #define SPIM_RTS_SS0_HSIOM_POS       (SPIM_uart_rts_spi_ss0__0__HSIOM_SHIFT)
    #define SPIM_RTS_SS0_HSIOM_SEL_GPIO  (SPIM_uart_rts_spi_ss0__0__HSIOM_GPIO)
    #define SPIM_RTS_SS0_HSIOM_SEL_I2C   (SPIM_uart_rts_spi_ss0__0__HSIOM_I2C)
    #define SPIM_RTS_SS0_HSIOM_SEL_SPI   (SPIM_uart_rts_spi_ss0__0__HSIOM_SPI)
#if !(SPIM_CY_SCBIP_V0 || SPIM_CY_SCBIP_V1)
    #define SPIM_RTS_SS0_HSIOM_SEL_UART  (SPIM_uart_rts_spi_ss0__0__HSIOM_UART)
...
#define SPIM_CTS_SCLK_PIN_INDEX       (2u)
#define SPIM_RTS_SS0_PIN_INDEX       (3u)
...
#define SPIM_CTS_SCLK_PIN_MASK     ((uint32) 0x01u << SPIM_CTS_SCLK_PIN_INDEX)
#define SPIM_RTS_SS0_PIN_MASK     ((uint32) 0x01u << SPIM_RTS_SS0_PIN_INDEX)
...
#if (SPIM_RTS_SS0_PIN)
    #define SPIM_CHECK_RTS_SS0_PIN_USED \
                (SPIM_PIN_DM_ALG_HIZ != \
                    SPIM_GET_P4_PIN_DM(SPIM_uart_rts_spi_ss0_PC, \
                                                   SPIM_uart_rts_spi_ss0_SHIFT))
#endif /* (SPIM_RTS_SS0_PIN) */
...
#define SPIM_REMOVE_SCLK_PIN                SPIM_REMOVE_CTS_SCLK_PIN
#endif /* SPIM_REMOVE_SCLK_PIN */
#ifndef SPIM_REMOVE_SS0_PIN
#define SPIM_REMOVE_SS0_PIN                 SPIM_REMOVE_RTS_SS0_PIN
...
#define SPIM_SCLK_PIN               SPIM_CTS_SCLK_PIN
#endif /* SPIM_SCLK_PIN */
#ifndef SPIM_SS0_PIN
#define SPIM_SS0_PIN                SPIM_RTS_SS0_PIN
#endif /* SPIM_SS0_PIN */
    ...
    #define SPIM_SCLK_HSIOM_REG     SPIM_CTS_SCLK_HSIOM_REG
    #define SPIM_SCLK_HSIOM_PTR     SPIM_CTS_SCLK_HSIOM_PTR
    #define SPIM_SCLK_HSIOM_MASK    SPIM_CTS_SCLK_HSIOM_MASK
    #define SPIM_SCLK_HSIOM_POS     SPIM_CTS_SCLK_HSIOM_POS
    #endif /* SPIM_SCLK_HSIOM_REG */
#endif /* (SPIM_SCLK_PIN) */

#if (SPIM_SS0_PIN)
    #ifndef SPIM_SS0_HSIOM_REG
    #define SPIM_SS0_HSIOM_REG      SPIM_RTS_SS0_HSIOM_REG
    #define SPIM_SS0_HSIOM_PTR      SPIM_RTS_SS0_HSIOM_PTR
    #define SPIM_SS0_HSIOM_MASK     SPIM_RTS_SS0_HSIOM_MASK
    #define SPIM_SS0_HSIOM_POS      SPIM_RTS_SS0_HSIOM_POS
...
#define SPIM_SCLK_PIN_INDEX             SPIM_CTS_SCLK_PIN_INDEX
#endif /* SPIM_SCLK_PIN_INDEX */
#ifndef SPIM_SS0_PIN_INDEX
#define SPIM_SS0_PIN_INDEX              SPIM_RTS_SS0_PIN_INDEX
...
#define SPIM_SCLK_PIN_MASK             SPIM_CTS_SCLK_PIN_MASK
#endif /* SPIM_SCLK_PIN_MASK */
#ifndef SPIM_SS0_PIN_MASK
#define SPIM_SS0_PIN_MASK              SPIM_RTS_SS0_PIN_MASK
