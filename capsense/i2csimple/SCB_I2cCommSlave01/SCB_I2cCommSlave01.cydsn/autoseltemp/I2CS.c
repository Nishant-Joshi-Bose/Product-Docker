...
static void I2CS_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void I2CS_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            I2CS_SCL_HSIOM_SEL_GPIO,
            I2CS_SDA_HSIOM_SEL_GPIO,
        ...
        {
        #if (I2CS_SCL_PIN)
            hsiomSel[I2CS_SCL_PIN_INDEX] = I2CS_SCL_HSIOM_SEL_I2C;
            pinsDm  [I2CS_SCL_PIN_INDEX] = I2CS_PIN_DM_OD_LO;
        ...
        #if (I2CS_SDA_PIN)
            hsiomSel[I2CS_SDA_PIN_INDEX] = I2CS_SDA_HSIOM_SEL_I2C;
            pinsDm  [I2CS_SDA_PIN_INDEX] = I2CS_PIN_DM_OD_LO;
        #endif /* (I2CS_SDA_PIN) */
        }
    #if (!I2CS_CY_SCBIP_V1)
        ...
        {
        #if (I2CS_SCL_PIN)
            hsiomSel[I2CS_SCL_PIN_INDEX] = I2CS_SCL_HSIOM_SEL_SPI;
        #elif (I2CS_RX_WAKE_SDA_MOSI_PIN)
        ...
        #if (I2CS_SDA_PIN)
            hsiomSel[I2CS_SDA_PIN_INDEX] = I2CS_SDA_HSIOM_SEL_SPI;
        #endif /* (I2CS_SDA_PIN) */
            ...
            {
                /* Slave */
                pinsDm[I2CS_SCL_PIN_INDEX] = I2CS_PIN_DM_DIG_HIZ;
                pinsDm[I2CS_SDA_PIN_INDEX] = I2CS_PIN_DM_STRONG;
                ...
                /* Disable input buffer */
                 pinsInBuf |= I2CS_SDA_PIN_MASK;
            #endif /* (I2CS_SDA_PIN) */
            }
            else 
            {
                /* (Master) */
                pinsDm[I2CS_SCL_PIN_INDEX] = I2CS_PIN_DM_STRONG;
                pinsDm[I2CS_SDA_PIN_INDEX] = I2CS_PIN_DM_DIG_HIZ;
        ...
        else /* UART */
        {
            if (I2CS_UART_MODE_SMARTCARD == subMode)
            {
                /* SmartCard */
            #if (I2CS_SDA_PIN)
                hsiomSel[I2CS_SDA_PIN_INDEX] = I2CS_SDA_HSIOM_SEL_UART;
                pinsDm  [I2CS_SDA_PIN_INDEX] = I2CS_PIN_DM_OD_LO;
            #endif /* (I2CS_SDA_PIN) */
            }
            else /* Standard or IrDA */
            {
                ...
                {
                #if (I2CS_SCL_PIN)
                    hsiomSel[I2CS_SCL_PIN_INDEX] = I2CS_SCL_HSIOM_SEL_UART;
                    pinsDm  [I2CS_SCL_PIN_INDEX] = I2CS_PIN_DM_DIG_HIZ;
                #elif (I2CS_RX_WAKE_SDA_MOSI_PIN)
    ...
    /* Note: the DR register settings do not effect the pin output if HSIOM is other than GPIO */
        ...
        I2CS_SET_HSIOM_SEL(I2CS_SCL_HSIOM_REG,
                                       I2CS_SCL_HSIOM_MASK,
                                       I2CS_SCL_HSIOM_POS,
                                        hsiomSel[I2CS_SCL_PIN_INDEX]);

        I2CS_i2c_scl_SetDriveMode((uint8) pinsDm[I2CS_SCL_PIN_INDEX]);

        #if (!I2CS_CY_SCBIP_V1)
            I2CS_SET_INP_DIS(I2CS_i2c_scl_INP_DIS,
                                         I2CS_i2c_scl_MASK,
                                         (0u != (pinsInBuf & I2CS_SCL_PIN_MASK)));
        #endif /* (!I2CS_CY_SCBIP_V1) */
    ...
    #if (I2CS_SDA_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_SDA_HSIOM_REG,
                                       I2CS_SDA_HSIOM_MASK,
                                       I2CS_SDA_HSIOM_POS,
                                        hsiomSel[I2CS_SDA_PIN_INDEX]);

        I2CS_i2c_sda_SetDriveMode((uint8) pinsDm[I2CS_SDA_PIN_INDEX]);

    #if (!I2CS_CY_SCBIP_V1)
        I2CS_SET_INP_DIS(I2CS_i2c_sda_INP_DIS,
                                     I2CS_i2c_sda_MASK,
                                    (0u != (pinsInBuf & I2CS_SDA_PIN_MASK)));
    #endif /* (!I2CS_CY_SCBIP_V1) */
    #endif /* (I2CS_SCL_PIN) */
