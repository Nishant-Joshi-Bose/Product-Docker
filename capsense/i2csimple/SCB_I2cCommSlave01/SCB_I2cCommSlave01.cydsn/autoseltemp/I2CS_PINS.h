...
#define I2CS_REMOVE_SCL_PIN      (1u)
#define I2CS_REMOVE_SDA_PIN      (1u)
...
#define I2CS_SCL_PIN     (0u == I2CS_REMOVE_SCL_PIN)
#define I2CS_SDA_PIN     (0u == I2CS_REMOVE_SDA_PIN)
...
#if (I2CS_SCL_PIN)
    #include "I2CS_i2c_scl.h"
#endif /* (I2CS_SCL) */

#if (I2CS_SDA_PIN)
    #include "I2CS_i2c_sda.h"
#endif /* (I2CS_SDA) */
...
#if (I2CS_SCL_PIN)
    #define I2CS_SCL_HSIOM_REG   (*(reg32 *) I2CS_i2c_scl__0__HSIOM)
    #define I2CS_SCL_HSIOM_PTR   ( (reg32 *) I2CS_i2c_scl__0__HSIOM)
    
    #define I2CS_SCL_HSIOM_MASK      (I2CS_i2c_scl__0__HSIOM_MASK)
    #define I2CS_SCL_HSIOM_POS       (I2CS_i2c_scl__0__HSIOM_SHIFT)
    #define I2CS_SCL_HSIOM_SEL_GPIO  (I2CS_i2c_scl__0__HSIOM_GPIO)
    #define I2CS_SCL_HSIOM_SEL_I2C   (I2CS_i2c_scl__0__HSIOM_I2C)
    #define I2CS_SCL_HSIOM_SEL_SPI   (I2CS_i2c_scl__0__HSIOM_SPI)
    #define I2CS_SCL_HSIOM_SEL_UART  (I2CS_i2c_scl__0__HSIOM_UART)
...
#else
    /* None of pins I2CS_SCL_PIN or I2CS_RX_WAKE_SDA_MOSI_PIN present.*/
#endif /* (I2CS_SCL_PIN) */

#if (I2CS_SDA_PIN)
    #define I2CS_SDA_HSIOM_REG   (*(reg32 *) I2CS_i2c_sda__0__HSIOM)
    #define I2CS_SDA_HSIOM_PTR   ( (reg32 *) I2CS_i2c_sda__0__HSIOM)
    
    #define I2CS_SDA_HSIOM_MASK      (I2CS_i2c_sda__0__HSIOM_MASK)
    #define I2CS_SDA_HSIOM_POS       (I2CS_i2c_sda__0__HSIOM_SHIFT)
    #define I2CS_SDA_HSIOM_SEL_GPIO  (I2CS_i2c_sda__0__HSIOM_GPIO)
    #define I2CS_SDA_HSIOM_SEL_I2C   (I2CS_i2c_sda__0__HSIOM_I2C)
    #define I2CS_SDA_HSIOM_SEL_SPI   (I2CS_i2c_sda__0__HSIOM_SPI)
    #define I2CS_SDA_HSIOM_SEL_UART  (I2CS_i2c_sda__0__HSIOM_UART)
#endif /* (I2CS_SDA_PIN) */
...
#define I2CS_SCL_PIN_INDEX       (0u)
#define I2CS_SDA_PIN_INDEX       (1u)
...
#define I2CS_SCL_PIN_MASK     ((uint32) 0x01u << I2CS_SCL_PIN_INDEX)
#define I2CS_SDA_PIN_MASK     ((uint32) 0x01u << I2CS_SDA_PIN_INDEX)
...
#if (I2CS_SDA_PIN)
    #define I2CS_CHECK_SDA_PIN_USED \
                (I2CS_PIN_DM_ALG_HIZ != \
                    I2CS_GET_P4_PIN_DM(I2CS_i2c_sda_PC, \
                                                   I2CS_i2c_sda_SHIFT))
#endif /* (I2CS_SDA_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define I2CS_WAIT_SCL_SET_HIGH  (0u == I2CS_i2c_scl_Read())
...
#elif (I2CS_SDA_PIN)
    #define I2CS_WAIT_SDA_SET_HIGH  (0u == I2CS_i2c_sda_Read())
#else
...
#define I2CS_REMOVE_MOSI_SCL_RX_PIN         I2CS_REMOVE_SCL_PIN
#define I2CS_REMOVE_MISO_SDA_TX_PIN         I2CS_REMOVE_SDA_PIN
...
#define I2CS_MOSI_SCL_RX_PIN        I2CS_SCL_PIN
#define I2CS_MISO_SDA_TX_PIN        I2CS_SDA_PIN
...
#define I2CS_SS0_PIN                I2CS_RTS_SS0_PIN
    ...
    #define I2CS_MOSI_SCL_RX_HSIOM_REG      I2CS_SCL_HSIOM_REG
    #define I2CS_MOSI_SCL_RX_HSIOM_PTR      I2CS_SCL_HSIOM_PTR
    #define I2CS_MOSI_SCL_RX_HSIOM_MASK     I2CS_SCL_HSIOM_MASK
    #define I2CS_MOSI_SCL_RX_HSIOM_POS      I2CS_SCL_HSIOM_POS
#endif /* (I2CS_MOSI_SCL_RX_PIN) */

#if (I2CS_MISO_SDA_TX_PIN)
    #define I2CS_MISO_SDA_TX_HSIOM_REG      I2CS_SDA_HSIOM_REG
    #define I2CS_MISO_SDA_TX_HSIOM_PTR      I2CS_SDA_HSIOM_REG
    #define I2CS_MISO_SDA_TX_HSIOM_MASK     I2CS_SDA_HSIOM_REG
    #define I2CS_MISO_SDA_TX_HSIOM_POS      I2CS_SDA_HSIOM_REG
...
#define I2CS_MOSI_SCL_RX_PIN_INDEX      I2CS_SCL_PIN_INDEX
#define I2CS_MISO_SDA_TX_PIN_INDEX      I2CS_SDA_PIN_INDEX
...
#define I2CS_MOSI_SCL_RX_PIN_MASK      I2CS_SCL_PIN_MASK
#define I2CS_MISO_SDA_TX_PIN_MASK      I2CS_SDA_PIN_MASK
