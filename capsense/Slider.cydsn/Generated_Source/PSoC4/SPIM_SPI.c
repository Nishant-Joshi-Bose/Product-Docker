...
void SPIM_SpiPostEnable(void)
{
    ...
    if (SPIM_CHECK_SPI_MASTER)
    {
        ...
        SPIM_SET_HSIOM_SEL(SPIM_CTS_SCLK_HSIOM_REG, SPIM_CTS_SCLK_HSIOM_MASK,
                                       SPIM_CTS_SCLK_HSIOM_POS, SPIM_CTS_SCLK_HSIOM_SEL_SPI);
    #endif /* (SPIM_CTS_SCLK_PIN) */

    #if (SPIM_RTS_SS0_PIN)
        /* Set SCB SPI to drive output pin */
        SPIM_SET_HSIOM_SEL(SPIM_RTS_SS0_HSIOM_REG, SPIM_RTS_SS0_HSIOM_MASK,
                                       SPIM_RTS_SS0_HSIOM_POS, SPIM_RTS_SS0_HSIOM_SEL_SPI);
...
void SPIM_SpiStop(void)
{
    ...
    if (SPIM_CHECK_SPI_MASTER)
    {
        ...
        SPIM_uart_cts_spi_sclk_Write(SPIM_GET_SPI_SCLK_INACTIVE);

        /* Set GPIO to drive output pin */
        SPIM_SET_HSIOM_SEL(SPIM_CTS_SCLK_HSIOM_REG, SPIM_CTS_SCLK_HSIOM_MASK,
                                       SPIM_CTS_SCLK_HSIOM_POS, SPIM_CTS_SCLK_HSIOM_SEL_GPIO);
    #endif /* (SPIM_uart_cts_spi_sclk_PIN) */

    #if (SPIM_RTS_SS0_PIN)
        /* Set output pin state after block is disabled */
        SPIM_uart_rts_spi_ss0_Write(SPIM_GET_SPI_SS0_INACTIVE);

        /* Set GPIO to drive output pin */
        SPIM_SET_HSIOM_SEL(SPIM_RTS_SS0_HSIOM_REG, SPIM_RTS_SS0_HSIOM_MASK,
                                       SPIM_RTS_SS0_HSIOM_POS, SPIM_RTS_SS0_HSIOM_SEL_GPIO);
    #endif /* (SPIM_uart_rts_spi_ss0_PIN) */
