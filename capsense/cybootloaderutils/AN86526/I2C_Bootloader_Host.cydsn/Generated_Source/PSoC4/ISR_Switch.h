...
#define ISR_Switch_INTC_VECTOR            ((reg32 *) ISR_Switch__INTC_VECT)

/* Address of the ISR_Switch ISR priority. */
#define ISR_Switch_INTC_PRIOR             ((reg32 *) ISR_Switch__INTC_PRIOR_REG)
...
#define ISR_Switch_INTC_SET_EN            ((reg32 *) ISR_Switch__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the ISR_Switch interrupt. */
#define ISR_Switch_INTC_CLR_EN            ((reg32 *) ISR_Switch__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the ISR_Switch interrupt state to pending. */
#define ISR_Switch_INTC_SET_PD            ((reg32 *) ISR_Switch__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the ISR_Switch interrupt. */
#define ISR_Switch_INTC_CLR_PD            ((reg32 *) ISR_Switch__INTC_CLR_PD_REG)
