...
IPKS = recovery.ipk product-script.ipk software-update.ipk wpe.ipk monaco.ipk product.ipk gva.ipk lpm_updater.ipk
PACKAGENAMES = SoundTouchRecovery product-script software-update wpe monaco SoundTouch gva lpm_updater
...
IPKS_HSP = recovery.ipk product-script.ipk software-update.ipk hsp.ipk wpe.ipk monaco.ipk product.ipk gva.ipk lpm_updater.ipk
PACKAGENAMES_HSP = SoundTouchRecovery product-script software-update hsp wpe monaco SoundTouch gva lpm_updater
...
.PHONY: packages-gz
packages-gz: generate-metadata product-ipk wpe-ipk softwareupdate-ipk monaco-ipk hsp-ipk lpmupdater-ipk recovery-ipk product-script-ipk gva-ipk
