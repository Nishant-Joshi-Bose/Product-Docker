EXECUTE_PROCESS(COMMAND components get googletest-${SDK} installed_location
  OUTPUT_VARIABLE GOOGLETEST_DIR
  RESULT_VARIABLE RESULT
  OUTPUT_STRIP_TRAILING_WHITESPACE)
IF(RESULT)
  MESSAGE(FATAL_ERROR "No GOOGLETEST_DIR")
ENDIF()
MESSAGE(STATUS "GOOGLETEST_DIR is '${GOOGLETEST_DIR}'")

EXECUTE_PROCESS(COMMAND components get RivieraLPM installed_location
  OUTPUT_VARIABLE RIVIERA_LPM_DIR
  RESULT_VARIABLE RESULT
  OUTPUT_STRIP_TRAILING_WHITESPACE)
IF(RESULT)
  MESSAGE(FATAL_ERROR "No RIVIERA_LPM_DIR")
ENDIF()
MESSAGE(STATUS "RIVIERA_LPM_DIR is '${RIVIERA_LPM_DIR}'")

EXECUTE_PROCESS(COMMAND components get RivieraLpmService installed_location
  OUTPUT_VARIABLE RIVIERA_LPM_SERVICE_DIR
  RESULT_VARIABLE RESULT
  OUTPUT_STRIP_TRAILING_WHITESPACE)
IF(RESULT)
  MESSAGE(FATAL_ERROR "No RIVIERA_LPM_SERVICE_DIR")
ENDIF()
MESSAGE(STATUS "RIVIERA_LPM_SERVICE_DIR is '${RIVIERA_LPM_SERVICE_DIR}'")
