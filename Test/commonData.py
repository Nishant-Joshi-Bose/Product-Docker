...
keyConfig= \
    { "keyTable":
        ...
        {"origin": 0, "keyEvent": 1, "keyList": [3], "timeOutList": [20], "action": 1023, "comment": "Console: VolumeUp(+) release ---> VolumeUp"},
        {"origin": 0, "keyEvent": 3, "keyList": [3], "timeOutList": [300,100], "action": 1039, "comment": "Console: VolumeUp(+) Press and Hold ---> VolumeRampUp"},

        {"origin": 0, "keyEvent": 1, "keyList": [5], "timeOutList": [20], "action": 1024, "comment": "Console: VolumeUp(-) release ---> VolumeDown"},
