...
keyConfig= \
    {"keyTable":
        ...
        {"origin": 0, "keyEvent": 1, "keyList": [2], "timeOutList":[20], "action":1025,"comment":"Console: AUX release ---> SendToAux"},
        {"origin": 0, "keyEvent": 1, "keyList": [6], "timeOutList":[20], "action":1026,"comment":"Console: action release ---> Alexa"},
